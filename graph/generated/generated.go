...
var sources = []*ast.Source{
	&ast.Source{Name: "schema.graphql", Input: `# Userデータの定義
type User {
  id: ID!
  name: String!
}
...
# データ取得API(userのIDを指定すると、Userデータが返ってくるイメージ)
type Query {
  user(id: ID): User!
  dog(id: ID): Dog!
}
...
func (ec *executionContext) _Query_user(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNUser2ᚖgithubᚗcomᚋMitsuguSueyoshiᚋgraphqlᚑgolangᚑtodosᚋgraphᚋmodelᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_dog(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNDog2ᚖgithubᚗcomᚋMitsuguSueyoshiᚋgraphqlᚑgolangᚑtodosᚋgraphᚋmodelᚐDog(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNDog2githubᚗcomᚋMitsuguSueyoshiᚋgraphqlᚑgolangᚑtodosᚋgraphᚋmodelᚐDog(ctx context.Context, sel ast.SelectionSet, v model.Dog) graphql.Marshaler {
	return ec._Dog(ctx, sel, &v)
}

func (ec *executionContext) marshalNDog2ᚖgithubᚗcomᚋMitsuguSueyoshiᚋgraphqlᚑgolangᚑtodosᚋgraphᚋmodelᚐDog(ctx context.Context, sel ast.SelectionSet, v *model.Dog) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalNUser2githubᚗcomᚋMitsuguSueyoshiᚋgraphqlᚑgolangᚑtodosᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v model.User) graphql.Marshaler {
	return ec._User(ctx, sel, &v)
}

func (ec *executionContext) marshalNUser2ᚖgithubᚗcomᚋMitsuguSueyoshiᚋgraphqlᚑgolangᚑtodosᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v *model.User) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
